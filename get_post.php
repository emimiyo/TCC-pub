<?php
	...
	echo'<div class="media border">
    	...
    	<figure class="figure">
			<img src="imagens/fundo.jpg" class="figure-img img-fluid rounded-lg" alt="">
			<figcaption class="figure-caption text-right"><i class="fas fa-dragon"></i> '.$registro['usuario'].'</figcaption>
		</figure>
		</div>';
				?>
		<div id="btn-del">
